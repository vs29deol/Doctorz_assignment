...
ActiveRecord::Schema.define(version: 2020_10_18_085100) do
  ...
  create_table "seats_shows", id: false, force: :cascade do |t|
    t.bigint "seat_id", null: false
    t.bigint "show_id", null: false
    t.index ["seat_id", "show_id"], name: "index_seats_shows_on_seat_id_and_show_id"
  end
